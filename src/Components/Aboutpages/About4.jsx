...
const About4 = () => {
  ...
  const styles = {
    container: {
      ...
      alignItems: 'flex-start', // Changed from 'center' to align content to the top
      padding: '10px 40px 60px 40px', // Removed top padding (was 60px)
    ...
    wrapper: {
      ...
      alignItems: 'flex-start', // Changed from 'center' to line up header with top edge
      gap: '60px',
    },
    leftContent: {
      flex: '1 1 500px',
