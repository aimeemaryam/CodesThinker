...
import devOpsImg from '../../assets/devops.webp'; // Update image path if needed
        ...
        <div className="space-y-8 pt-6">
          ...
          <div>
            <h2 className="text-2xl md:text-3xl font-bold text-black mb-2">
              Why Choose Us for DevOps & Cloud?
            </h2>
            <p className="text-gray-600 text-base">
              We offer expert-level devops & cloud services with results that speak for themselves.
            </p>
          </div>
