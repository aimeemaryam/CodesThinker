...
import graphicImg from '../../assets/graphic.webp'; // Update image path to match your assets folder
        ...
        <div className="space-y-8 pt-6">
          ...
          <div>
            ...
            <p className="text-gray-600 text-base">
              We offer expert-level graphic designing services with results that speak for themselves.
            </p>
          </div>
