...
import leadGenerationImg from '../../assets/lead-generation.webp'; // Update image path as needed

const LeadGeneration = () => {
  // Data for "Why Choose Us" feature cards based on the screenshots
  const features = [
    {
      id: 1,
      ...
      <div className="max-w-7xl mx-auto space-y-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="w-full h-auto rounded-3xl overflow-hidden shadow-lg bg-[#050038]">
            <img
              src={leadGenerationImg}
              alt="Lead Generation Detail"
        ...
        <div className="space-y-8 pt-6">
          ...
          <div>
            ...
            <p className="text-gray-600 text-base">
              We offer expert-level lead generation services with results that speak for themselves.
            </p>
          </div>
