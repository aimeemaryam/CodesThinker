...
import uiuxImg from '../../assets/uiux.webp'; // Update image path to match your assets folder
        ...
        <div className="space-y-8 pt-6">
          ...
          <div>
            <h2 className="text-2xl md:text-3xl font-bold text-black mb-2">
              Why Choose Us for UI/UX?
            </h2>
            <p className="text-gray-600 text-base">
              We offer expert-level ui/ux services with results that speak for themselves.
            </p>
          </div>
